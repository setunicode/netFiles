...
const storedMeta = {
	auth: 'r9uFxEs9GEVaQR9CJJ0uTKFGhFSOTRjOY2FCLFlCIZ0Cr-VGTVpMGlXDbNR8RMT55trMpSrzWtBVKq1LffOT2g',
...
describe('Owner Middleware', function () {
	...
	it('authenticates when the hashes match', async function () {
		...
		sinon.assert.calledWith(res.set, 'WWW-Authenticate', `send-v1 ${req.nonce}`)
